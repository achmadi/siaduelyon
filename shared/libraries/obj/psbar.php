...
class PSBar_1{
	...
	function selection_departemen($fmod,$dept){
		...
		if(admin_is_alldept()) 
			$s=iSelect('departemen',$departemen,$dept,'width:'.$this->selw,$fmod."_get()");
		else 
			$s='<b>'.departemen_name($dept).'</b><input type="hidden" id="departemen" value="'.$dept.'"/>';
		$this->selection($s);
	}
}
...
class PSBar_2{
	...
	function begin(){
		echo '<div class="tbltopmbar" style="width:100%">
