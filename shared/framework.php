<?php
	...
	* html .blueblock{ /*IE 6 only */
	...
	<!-- tambahan -->
		<link rel="stylesheet" type="text/css" media="screen" href="../shared/styles/jquery-ui-1.10.1.custom.css"/>
		<link rel="stylesheet" type="text/css" media="screen" href="../shared/styles/jquery.ui.combogrid.css"/>

		<script type="text/javascript" language="javascript" src="../shared/jquery-1.9.1.min.js"></script>
		<script type="text/javascript" language="javascript" src="../shared/jquery-ui-1.10.1.custom.min.js"></script>
		<script type="text/javascript" language="javascript" src="../shared/jquery.ui.combogrid-1.6.3.js"></script>
	<!-- end of tambahan -->
