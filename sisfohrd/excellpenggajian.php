...
header("content-disposition: attachment;filename=laporan_penggajian_".date('d-m-Y').".xls");
...
$logoslip="<img src='$url_situs/images/logoslip.png'>";
echo "</head><body>";
echo'<div align="left" class="borderbawah">'.$logoslip.'</div><br><br><br>';
